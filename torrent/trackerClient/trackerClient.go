...
func StartTrackerClient(dialer proxy.Dialer, announce string, announceList [][]string, trackerInfoChan chan *meta.TrackerResponse, reports chan ClientStatusReport) {
...
func queryTrackers(dialer proxy.Dialer, announceList [][]string, report ClientStatusReport) (tr *meta.TrackerResponse) {
...
func queryTracker(dialer proxy.Dialer, report ClientStatusReport, trackerUrl string) (tr *meta.TrackerResponse, err error) {
...
func queryHTTPTracker(dialer proxy.Dialer, report ClientStatusReport, u *url.URL) (tr *meta.TrackerResponse, err error) {
	uq := u.Query()
	...
	tr, err = meta.TrackerInfo(dialer, u.String())
	if tr == nil || err != nil {
...
func queryUDPTracker(report ClientStatusReport, u *url.URL) (tr *meta.TrackerResponse, err error) {
...
func getAnnouncementFromUDPTracker(con *net.UDPConn, connectionID uint64, report ClientStatusReport) (tr *meta.TrackerResponse, err error) {
	transactionID := rand.Uint32()
