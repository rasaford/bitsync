...
type Provider interface {
	NewCache(infohash string, numPieces int, pieceLength int64, totalSize int64, undelying file.FileStore) file.FileStore
}
...
func NewRamCacheProvider(capacity int) Provider {
	rc := &RamProvider{capacity, make(map[string]*RamCache)}
	return rc
}

func (r *RamProvider) NewCache(infohash string, numPieces int, pieceSize int64, torrentLength int64, underlying file.FileStore) file.FileStore {
	i := uint32(1)
...
func (r *RamProvider) cacheClosed(infohash string) {
